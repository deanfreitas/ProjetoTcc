        ...
        <%@taglib uri="http://www.springframework.org/tags" prefix="spring" %>
            ...
            <html lang="pt-br">
                ...
                <head>
                    ...
                    <script src="<c:url value ='/resources/JavaScript/validarTelas/validarCadastro.js' />"
                    />
                    </script>
                </head>
                ...
                <!-- MODAL COM A OPÇÃO PARA SELECIONAR O TIPO DE CADASTRO -->
                    ...
                    <div class="container-fluid col-md-12" id="pagina">
                        <div class="col-md-12" id="idLogo">
                            ...
                            <img src="<c:url value = '/resources/Imagens/imagensTelas/novologotransp2.png' />"
                        ...
                        <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="optradio" id="radioSexo" value="Masculino">
                                        Masculino
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="optradio" id="radioSexo" value="Feminino">
                                        Feminino
                                    </label>
                                </div>
                                     <div class="form-group col-md-12">
                                <input type="email" class="form-control" id="idEmail" placeholder="E-mail"
                                data-toggle="tooltip" title="Digite o Email corretamente" required/>
                            </div>

                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" id="idApelido" placeholder="Apelido"
                                required/>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="password" class="form-control" id="validarSenha" name="senha"
                                                        size="30" required />
                                                        <br />
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" id="verificarSenha" data-dismiss="modal" class="btn btn-primary">
                                                OK
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-7" id="salvar">
                                    <form class="form-inline">
                                        ...
                                        <!-- Alterar dados -->
                                        <a type="button" id="btnAlterarDados" class="btn btn-raised btn-info"
                                        data-toggle="modal" href="#mymodal2">Alterar</a>
                                    </form>
                                </div>
                                <label class="col-md-4">
                                </label>
