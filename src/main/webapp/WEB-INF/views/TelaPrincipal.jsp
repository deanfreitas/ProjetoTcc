...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:url value ='/resources/Css/estiloTelas/estiloTelaPrincipal.css' />"/>
    <link rel="stylesheet" type="text/css"
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse navbar-responsive-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a type="button" id="btnAvaliacao" href="/ProjetoTcc/telaDiarioAlimentar">Diário Alimentar</a>
                    </li>
                </ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="imcForm" id="imcForm" action="#">
                        ...
                        <p><input name="Enviar" type="button" id="btnCalcular" class="btn btn-raised btn-default"
                                  value="Calcular"/>
                        </p>
                    </form>
                </div>
