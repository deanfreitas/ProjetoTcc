...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:url value ='/resources/Css/estiloTelas/estiloTelaResultados.css' />"/>
    ...
    <div class="jumbotron col-md-12">
        ...
        <div class="row col-md-12" id="DadosDoPaciente">
            ...
            <div class="col-md-6">
                ...
                <output type="text" class="form-control" aria-describedby="sizing-addon2"
                        id="idBebidasAlcoolicas"></output>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                ...
                <output type="text" class="form-control" aria-describedby="sizing-addon2"
                        id="idDiagnosticoNutricional"></output>
            </div>

            <div class="col-md-12">
                <span class="input-group" id="">RELATO DE CASO, ORIENTAÇÕES E EVOLUÇÃO:</span>
                <output type="text" class="form-control" rows="20" aria-describedby="sizing-addon2"
                        id="idRelatoCasoOrientacoesEvolucao"></output>
            </div>
        </div>
    </div>
</div>
