...
<div class="row">
  ...
  <div class="col-sm-6 col-md-4" id="idVitaminaD">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>Vitamina D</h3>
        <p>A vitamina D é fundamental no fortalecimento dos ossos e dentes e ajuda na coagulação do sangue.</p>
        <p><a href="#" class="btn btn-primary" id="btnVitaminaD" role="button">Onde encontrá-la?</a></p>
      </div>
    </div>
  </div>
   ...
   <div class="col-sm-6 col-md-4" id="idVitaminaE">
    <div class="thumbnail">
      ...
      <div class="caption">
        <h3>Vitamina E</h3>
        <p>A vitamina E é uma vitamina solúvel em gordura que primeiramente funciona como um anti-oxidante, 
        o que significa que ajuda a prevenir ou reduzir os danos causados ​​por radicais livres, em última análise
         a redução do risco de problemas de saúde, como a doença cardíaca ou cancro.</p>
        <p><a href="#" class="btn btn-primary" id="btnVitaminaE" role="button">Onde encontrá-la?</a></p>
      </div>
    </div>
  </div>
